...
<br>Here is where we will describe the criteria we used to assess the condition of children Region 4. We will be comparing each of the indicators against the California and Los Angeles County rates, and assess equity by calculating and comparing index ratios.

The State of children in Long Beach is good|fair|poor based on the summary of each bucket of metrics (e.g., built environment (based on # of better) is fair or poor and child safety is better...)<br><br>
...
Description about why built environment indicators are important especially given the location of Central Long Beach and its proximity to severe pollutants. Would also love some root cause analysis here to elevate environmental inequities that exist and the history of activism in this area to improve air quality. 
