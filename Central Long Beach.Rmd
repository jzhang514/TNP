...
#make numbers have comma separators
library(scales)
...
# kbl(rate_table, col.names = c("", "Maltreated Children", "Children Under 18", "Maltreatment Rate"))%>%
#     kable_styling(bootstrap_options = c( "hover", "condensed"))

knitr::kable(rate_table, col.names = c("", "Maltreated Children", "Children Under 18", "Maltreatment Rate"))
